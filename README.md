...
`/swarm-builder:compile` (inject the contract block into each MD, lint prose against JSON) is designed and not built. `ISSUES.md` lists what is left, each one a bounded issue.
