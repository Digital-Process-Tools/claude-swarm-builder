...
```bash
python3 "${CLAUDE_PLUGIN_ROOT}/scripts/swarm_doctor.py" swarm.json --json > /tmp/swarm-findings.json
python3 "${CLAUDE_PLUGIN_ROOT}/scripts/swarm_reader.py" swarm.json --findings /tmp/swarm-findings.json -o swarm.html
```
